...
import com.android.common.adapter.BBaseAdapter;
import com.android.common.adapter.PhotoSelectionAdapter;
import com.android.common.core.data.Photo;
import com.android.common.core.data.PhotoBucket;
import com.android.common.core.presenter.PhotoSelectionPresenter;
import com.android.common.core.view.PhotoSelectionView;
import com.android.common.helper.PhotoSelectionHelper;
import com.android.common.utils.ImageUtils;
import com.android.common.utils.PremissionManager;
import com.android.common.utils.ToastUtil;
import com.android.common.widget.GridInsetDecoration;
import com.android.common.widget.PhotoBucketsDialog;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.back:
                ...
                break;
            case R.id.complete:
                List<Photo> photos = PhotoSelectionHelper.getInstance().getSelected();
                ArrayList<String> photoPaths = new ArrayList<String>();
                for (Photo photo : photos) {
                    photoPaths.add(photo.getPhotoPath());
                }
                Intent intent = new Intent();
                intent.putStringArrayListExtra(SELECTION_PHOTOS, photoPaths);
                setResult(RESPOND_SELECTION_PHOTOS_CODE, intent);
                finish();
                break;
            case R.id.tv_photo_bucket_name:
                showTimePicker();
                break;
            case R.id.tv_photo_browse:
