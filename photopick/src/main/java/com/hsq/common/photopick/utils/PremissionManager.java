...
public class PremissionManager {
    ...
    public static List<String> checkRequestPremissions(Context context,List<String> requestPermissions) {
        List<String> permissions = new ArrayList<String>(requestPermissions.size());
